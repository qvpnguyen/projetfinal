...
<body>
    ...
    <div class="container p-5 my-5 border bg-light w-50">
        ...
        <div class="d-flex justify-content-center">
            <form action="<?php echo DOSSIER_RACINE;?>/vues/redirection.php" method="post">
                <div class="form-group">
                    <label for="choix_couleur" class="form-label">Couleur de l'arrière-plan</label>
                    <br>
                    <input type="text" class="form-control" id="choix_couleur" name="choix_couleur" value="#">
                </div>
                <br>
                <br>
                <input class="btn btn-secondary boutons" type="submit" value="Étape suivante" onmouseenter="changerFondBoutons();" onmouseleave="retablirFondBoutons();">
            </form>
        </div>
    </div>
</body>
